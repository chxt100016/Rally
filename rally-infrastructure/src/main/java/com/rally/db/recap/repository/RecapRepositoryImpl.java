package com.rally.db.recap.repository;
...
public class RecapRepositoryImpl implements RecapRepository {
    ...
    private Map<String, UserData> queryUsers(String... playerIds) {
        ...
        for (String uid : userIds) {
            userRepository.findByUserId(uid).ifPresent(data -> userMap.put(uid, data));
        }
        return userMap;
    }
