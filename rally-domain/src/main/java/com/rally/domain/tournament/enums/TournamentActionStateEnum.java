...
public enum TournamentActionStateEnum {
    ...
    FROZEN("已冻结", "报名暂时冻结", "完成手机号绑定后可解冻报名，解冻后将重新进入匹配池。"),
    ...
    AWAIT_COURT_BOOKER_SELECT("协商赛约", "本场比赛待确定订场人", "对阵%s。系统暂无法自动确定订场人，双方均可认领订场，认领后确定球场与时间即可开赛。"),
    ...
    WAITING_MATCH("匹配中", "正在为你匹配对手", "你已进入匹配池，系统将在池内积累到一定规模后自动匹配。若长时间未匹配到对手，可尝试调整「活动区域」与「可约时间」以提高匹配成功率。"),
