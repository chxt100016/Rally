...
public enum TournamentActionStateEnum {
    ...
    AWAIT_QUALIFIER_START("待匹配", "报名成功，等待赛事开始", "报名成功，赛事即将开始匹配。点击右上角「加入群聊」，及时获取开赛通知。"),
    AWAIT_PAYMENT("待支付", "支付报名费，锁定正赛席位", "你已晋级正赛，请在截止前完成支付以保留席位。"),
    AWAIT_COURT_BOOKER_SELECT("协商赛约", "本场比赛待确定订场人", "对阵%s。系统暂未分配订场人，双方均可认领，确定球场和时间后即可开赛。"),
    AWAIT_BOOKING("协商赛约", "你已认领订场，请提交场地信息", "对阵%s。提交球场与时间，对手确认后即可开赛。"),
    AWAIT_BOOKING_REBOOK("协商赛约", "请重新提交场地信息", "%s因“%s”打回了赛约，请点击下方卡片重新提交。"),
    AWAIT_BOOKING_OPPONENT("协商赛约", "对方订场中", "对阵%s，对方正在提交球场与时间，请耐心等候。"),
    ...
    WAITING_MATCH("匹配中", "正在为你匹配对手", "你已进入匹配池，系统会自动为你匹配对手。长时间未匹配成功，可尝试调整「活动区域」与「可约时间」。"),
