...
public enum TourRoundEnum {
    ...
    public static String of(String str) {
        ...
        TourRoundEnum target = null;
        switch (str) {
            case "Final" -> target = FINAL;
            case "Semifinal", "Semifinals" -> target = SEMIFINAL;
            case "Quarterfinal", "Quarterfinals" -> target = QUARTERFINAL;
