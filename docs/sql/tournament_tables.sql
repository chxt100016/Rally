...
CREATE TABLE `rally_tournament` (
    ...
    `offline_from_round` VARCHAR(16) DEFAULT NULL COMMENT '几强后转线下：ROUND_4/ROUND_8/ROUND_16；为空表示全程线上',
    ...
    `status` VARCHAR(16) NOT NULL DEFAULT 'DRAFT' COMMENT '状态：DRAFT/ACTIVE/FINISHED/ABANDONED',
    ...
    `champion_entry_no` INT DEFAULT NULL COMMENT '冠军报名编号，双打时表示冠军队伍',
