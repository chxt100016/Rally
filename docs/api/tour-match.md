...
**示例**
```
GET /api/rally/tour/match/upcoming?tournamentIds=t001&tournamentIds=t002
```
...
**示例**
```
GET /api/rally/tour/match/finished?tournamentIds=t001&tournamentIds=t002
```
