...
public class ScoreAppService {
    ...
    private ScoreItemDTO toItem(String userId, ScoreRecordData r) {
        ...
        GenderEnum mateGender = userInSideA ? (userId.equals(r.getSideAPlayer1()) ? r.getSideAPlayer2Gender() : r.getSideAPlayer1Gender()) : (userId.equals(r.getSideBPlayer1()) ? r.getSideBPlayer2Gender() : r.getSideBPlayer1Gender());
        // 对手
        ...
        GenderEnum opp1Gender = userInSideA ? r.getSideBPlayer1Gender() : r.getSideAPlayer1Gender();
        ...
        GenderEnum opp2Gender = userInSideA ? r.getSideBPlayer2Gender() : r.getSideAPlayer2Gender();
