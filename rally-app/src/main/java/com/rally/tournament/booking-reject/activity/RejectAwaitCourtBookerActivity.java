...
/**
 * 业务活动 reject-await-court-booker：待选订场人超时后终止比赛并释放报名。
 */
@Component
@RequiredArgsConstructor
public class RejectAwaitCourtBookerActivity {
    ...
    public void execute(
        ...
        // A1-A3：既有流程保留 MATCHED/参与身份/匹配超时校验、版本保存及跨聚合结算。
        TournamentMatch rejectedMatch = rejectionSupport.requireMatch(matchId);
        rejectedMatch.rejectOnAwaitCourtBookerSelect(participantUserId, rejectReason);
