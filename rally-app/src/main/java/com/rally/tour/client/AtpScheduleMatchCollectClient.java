...
/**
 * ATP 赛程采集 Client，对应 app.atptour.com /scores/schedule 接口。
 * 响应结构与 WtaScheduleResponse 相同，按赛事+年份拉取，
 * 过滤 Tour=ATP 且 MatchId 以 "MS" 开头的单打比赛。
 */
@Slf4j
@Component
public class AtpScheduleMatchCollectClient extends AbstractMatchCollectClient<WtaScheduleResponse, WtaScheduleResponse.ScheduleData> {
