...
| 等级 | 待定的是什么 | 要谁来定 |
|---|---|---|
| P2 | 目标用户不存在时返回“登录凭证无效，请重新登录”，但失效的是目标用户而非发起人登录凭证；需产品负责人确定正式对外提示。 | 产品与社区运营负责人 |
| P2 | “不能关注自己”与“请先完善用户信息”复用了同一业务错误码 `40010`；需产品与技术负责人确定对外错误码口径。 | 产品与社区运营负责人 |
| P1 | 连续重复关注会按成功处理，但并发的两次首次关注可能使后一次因唯一性冲突返回系统异常；需产品负责人确定两种重复场景是否都应承诺成功。 | 产品与社区运营负责人 |
| P1 | 目标用户编号只校验非空白，不会去除首尾空白，也没有格式或长度规则；需产品负责人确定有效用户编号的输入口径。 | 产品与社区运营负责人 |
| P1 | 关注时只校验登录凭据，不再确认发起人的 `user` 记录仍存在；需产品负责人确定账户被删除但凭据仍有效时是否可建立关注。 | 产品与社区运营负责人 |
| P2 | 建立关系后没有再确认记录已实际保存；若保存未报错但也未新增记录，仍会返回成功，需技术负责人确认是否存在该场景并补充成功判据。 | 产品与社区运营负责人 |
| P2 | 未定义私密账户、拉黑关系、账户停用或关注数上限等关注限制；需产品负责人确定是否需要这些规则。 | 产品与社区运营负责人 |
| P2 | `user_follow` 没有与 `user` 的外键或账户删除后的关系处理规则；需产品与数据负责人确定账户删除、注销或失效时关注关系的终态。 | 产品与社区运营负责人 |
