...
| 等级 | 待定的是什么 | 要谁来定 |
|---|---|---|
| P2 | 当前 HTTP 入口只传入赛事编号和年份，没有传入或查询 `tour`；后续必须据此在 `MS` 与 `LS` 间分流，因此当前成功路径不可达，需研发确认从赛事名录补齐巡回赛类型。 | 产品与职业赛事数据负责人 |
| P1 | 入口未体现运营身份校验，哪些账户可以发起结果采集需要业务负责人确认。 | 产品与职业赛事数据负责人 |
| P1 | 赛事编号和年份没有格式、范围或一致性校验，合法输入规则需要赛事数据负责人确认。 | 产品与职业赛事数据负责人 |
| P2 | ATP Tour App 的完赛结果同时承载 ATP 的 `MS` 与 WTA 的 `LS`，但支持范围及编号前缀口径没有业务说明，需要赛事数据负责人确认。 | 产品与职业赛事数据负责人 |
| P1 | 完赛结果来源若返回 `S`、`Scheduled`、`U`、`C` 或 `P`，现有规则仍会把比赛改为待开始、待定或进行中；已结束状态能否回退需要赛事数据负责人确认。 | 产品与职业赛事数据负责人 |
| P2 | 来源提供比赛日期，但当前结果采集不写入 `match_date`；完赛结果是否应补齐比赛日期需要赛事数据负责人确认。 | 产品与职业赛事数据负责人 |
| P2 | 来源提供球员姓名，但当前结果采集既不保存姓名也不刷新 `tour_player`；球员资料补齐责任需要赛事数据负责人确认。 | 产品与职业赛事数据负责人 |
| P2 | 逐盘比分以第一方盘列表为准，第二方缺少同盘数据时仍保存该盘且第二方局数为空；残缺比分能否作为有效赛果需要赛事数据负责人确认。 | 产品与职业赛事数据负责人 |
| P2 | 签表不存在时会建立 `size`、`total_rounds` 均为空的签表；完赛结果能否独立建立不完整签表需要赛事数据负责人确认。 | 产品与职业赛事数据负责人 |
| P2 | 双打结果固定不采集，是否需要纳入职业赛事结果需要业务负责人确认。 | 产品与职业赛事数据负责人 |
| P1 | 对外完成文案不区分空数据、赛事不匹配、赛事未收录、全部成功或部分成功，运营可见的结果标准需要产品确认。 | 产品与职业赛事数据负责人 |
