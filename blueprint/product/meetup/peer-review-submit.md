...
| 等级 | 待定的是什么 | 要谁来定 |
|---|---|---|
| P2 | 待产品负责人确定：评价人的正式资格是否仅限 `JOINED`；当前发布者、`PENDING`、`REVIEWED`、`SKIPPED` 用户也可能提交。 | 产品与约球运营负责人 |
| P1 | 待产品负责人确定：被评价人必须是本场其他有效参与者及禁止自评的规则；当前虽已有相应错误定义，但提交时未执行校验。 | 产品与约球运营负责人 |
| P2 | 待产品负责人确定：一次评价必须包含哪些维度；当前可只提交任意一个维度，也可提交空列表。 | 产品与约球运营负责人 |
| P1 | 待产品负责人确定：个性化标签是否只能来自默认标签、是否允许自定义、空标签和重复标签，以及数量与长度上限；当前仅要求值不为 `null`。 | 产品与约球运营负责人 |
| P1 | 待产品负责人确定：同一请求重复提交同一维度时应拒绝还是采用最后一个值；当前采用最后一个值。 | 产品与约球运营负责人 |
| P1 | 待产品负责人确定：`REVIEWED` 或 `SKIPPED` 后是否允许再次提交评价，以及再次提交后是否应改变复盘状态；当前允许保存但保持原状态。 | 产品与约球运营负责人 |
| P2 | 待产品负责人确定：进行中的约球是否应允许提前评价；当前约球到达开始时间即开放评价。 | 产品与约球运营负责人 |
| P2 | 待产品负责人确认：默认评价期限为约球结束后 `30` 天，且可由 `review.deadline_days` 调整，具体业务依据尚无说明。 | 产品与约球运营负责人 |
| P2 | 待产品负责人确定：没有其他有效参与者时是否应允许通过一次任意目标评价将复盘标记为已评价；当前会如此处理。 | 产品与约球运营负责人 |
