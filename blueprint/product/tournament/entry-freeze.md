...
| 等级 | 待定的是什么 | 要谁来定 |
|---|---|---|
| P1 | 当前不检查自办赛事是否存在、是否已激活或已废弃，也不检查赛事进度；哪些赛事状态和阶段允许运营冻结报名，需赛事产品负责人确认。 | 产品与赛事运营负责人 |
| P2 | 当前只要求报名处于 `WAITING`，资格赛与正赛、所有轮次均可冻结；不同阶段和轮次是否需要不同限制，需赛事产品负责人确认。 | 产品与赛事运营负责人 |
| P1 | 冻结请求没有原因、期限或操作人业务字段，冻结原因是否必填、是否自动到期以及如何留存运营审计，需赛事运营负责人确认。 | 产品与赛事运营负责人 |
| P2 | 双打报名由两名用户共享参赛编号，但当前仅冻结指定用户；其搭档仍为 `WAITING` 时，该参赛单元会因成员不完整而不能匹配。冻结是否应按整个参赛单元联动，需赛事产品负责人确认。 | 产品与赛事运营负责人 |
| P2 | 冻结成功不会通知参赛者；是否需要通知、通知渠道和展示文案，需赛事运营负责人确认。 | 产品与赛事运营负责人 |
| P2 | 冻结不检查参赛者是否已绑定手机号，而解冻要求本人已绑定手机号；由此造成长期无法自行解冻时的运营处理规则，需赛事产品负责人确认。 | 产品与赛事运营负责人 |
